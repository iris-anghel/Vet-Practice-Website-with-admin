...
<html>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6">
                <a href="add.php" type="button" class="btn btn-warning"><span class="glyphicon glyphicon-plus"></span> Adauga proprietar</a>
            </div>
        </div>
                ...
                <table class="table table-striped table-responsive table-condensed" id="owner_table">
                    ...
                    if( mysqli_num_rows($result) > 0 ) {
                        ...
                        while( $row = mysqli_fetch_assoc($result) ) {
                            ...
                            echo '<td><a href="edit.php?id=' . $row['id'] . '" type="button" class="btn btn-warning btn-sm">
